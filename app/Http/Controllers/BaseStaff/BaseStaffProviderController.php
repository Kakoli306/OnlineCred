...
class BaseStaffProviderController extends Controller
{
    public function provider()
    {
        return view('baseStaff.provider.providerList');
    }
    ...
    public function provider_list_by_fid(Request $request)
    {
        ...
        return response()->json([
            'notices' => $providers,
            'view' => View::make('baseStaff.provider.include.providerlistfid', compact('providers'))->render(),
    ...
    public function provider_list_by_faiclity($id)
    {
        ...
        $facility_id = $id;
        return view('baseStaff.provider.providerListFacility', compact('providers', 'facility_id'));
    }
    ...
    public function provider_info($id)
    {
        ...
        $spec = speciality::all();
        return view('baseStaff.provider.providerInfo', compact('provider', 'provider_info', 'provider_phones', 'provider_emails', 'provider_address', 'spec'));
    }
...
//            @unlink($provider_info->sig_file);
    ...
    public function provider_info_phone(Request $request)
    {
    ...
    public function provider_info_email(Request $request)
    {
    ...
    public function provider_info_address(Request $request)
    {
    ...
    public function provider_contract($id)
    {
        ...
        return view('baseStaff.provider.providerContract', compact('provider', 'provider_contracts', 'contact_name', 'contact_type', 'contact_status'));
    }
    ...
    public function provider_contract_note_save(Request $request)
    {
        ...
        if ($exist_reminder) {
            $new_reminder_user = reminder::where('contract_id', $new_note->contract_id)->first();
            $new_reminder_user->user_id = Auth::user()->id;
            $new_reminder_user->user_type = Auth::user()->account_type;
    ...
    public function provider_document($id)
    {
        ...
        return view('baseStaff.provider.providerDocument', compact('provider', 'provider_documents', 'providers_doc_type'));
    }
...
//            unlink($delete_doc->file);
    ...
    public function provider_document_all_doc_type(Request $request)
    {
    ...
    public function provider_portal($id)
    {
        ...
        return view('baseStaff.provider.providerPortal', compact('provider', 'portal', 'provider_all_email'));
    }
    ...
    public function provider_online_access($id)
    {
        ...
        return view('baseStaff.provider.providerOnlineAccess', compact('provider', 'provider_online_access'));
    }
    ...
    public function provider_activity($id)
    {
        ...
        return view('baseStaff.provider.providerActivity', compact('provider', 'activity'));
    }
