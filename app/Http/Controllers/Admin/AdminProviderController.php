...
//            ->first();
    ...
    public function provider_contract_add_note(Request $request)
    {
        ...
        $exist_reminder = reminder::where('contract_id', $new_note->contract_id)
            ->orderBy('id', 'desc')
            ->first();
...
//                ->where('assignedto_user_type', $user_type)
    ...
    {
        $note = provider_contract_note::where('contract_id', $request->id)
            ->orderBy('id', 'desc')
            ->get();
...
//            unlink($delete_doc->file);
    ...
    public function provider_insurance_document($id)
    {
        ...
        return view('admin.provider.providerInsuranceDocument', compact('provider', 'contract_name', 'document_types', 'all_ins_dcouments'));
    }
