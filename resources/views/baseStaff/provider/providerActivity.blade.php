    ...
    <div class="iq-card-body">
        <div class="d-flex justify-content-between mb-3">
            ...
            <div class="align-self-center">
                @if ($provider->practice_id != null)
                    <a href="{{route('.providers.list',$provider->practice_id)}}"
                       class="btn btn-sm btn-primarybasestaff go_back">
        ...
        <div class="d-lg-flex">
            <ul class="nav flex-column setting_menu">
                ...
                {{--                </li>--}}
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('basestaff.provider.activity',$provider->id)}}">Provider
                        Activity</a>
                </li>
            </ul>
