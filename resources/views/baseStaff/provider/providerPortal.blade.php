    ...
    <div class="iq-card-body">
        ...
        <div class="d-lg-flex">
            <ul class="nav flex-column setting_menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('basestaff.provider.portal',$provider->id)}}">Provider
                        Portal</a>
                </li>
                <li class="nav-item">
            ...
            <div class="all_content flex-fill">
                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <form action="{{route('basestaff.provider.portal.save')}}" method="post">
                            @csrf
                    ...
                    <div class="col-md-6 mb-2">
                        <form action="{{route('basestaff.provider.send.access')}}" method="post">
                            @csrf
