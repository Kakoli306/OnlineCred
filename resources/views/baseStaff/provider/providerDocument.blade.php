                ...
                <div class="modal fade" id="addoc" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('basestaff.provider.document.save')}}" method="post"
                        ...
                        @foreach($provider_documents as $doc)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('basestaff.provider.document.delete',$doc->id)}}"
                                       title="Delete">
                                    ...
                                    <div class="modal fade" id="editdoc{{$doc->id}}" data-backdrop="static">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('basestaff.provider.document.update')}}"
                                                      method="post"
                                                      enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-body">
    ...
    <script>
        $(document).ready(function () {
            ...
            const getAllType = () => {
                $.ajax({
                    type: "POST",
                    url: "{{route('basestaff.provider.get.all.doc.type')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                    },
