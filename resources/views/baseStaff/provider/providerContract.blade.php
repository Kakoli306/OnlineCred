                ...
                <div class="modal fade" id="createContract" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('basestaff.provider.contract.save')}}" method="post"
                        ...
                        @foreach($provider_contracts as $pcontract)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('basestaff.provider.contract.delete',$pcontract->id)}}"
                                       title="Delete">
                                    ...
                                    <div class="modal fade" id="editContract{{$pcontract->id}}" data-backdrop="static">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('basestaff.provider.contract.update')}}"
...
@endsection
@include('baseStaff.provider.include.contractjs')
