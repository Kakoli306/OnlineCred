    ...
    <div class="iq-card-body">
        ...
        <div class="d-lg-flex">
            <ul class="nav flex-column setting_menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('basestaff.insurance.document',$provider->id)}}">Insurance
                        Documents</a>
                </li>
                <li class="nav-item">
                ...
                <div class="modal fade" id="adInsdoc" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('basestaff.provider.insurance.document.save')}}" method="post"
                        ...
                        @foreach($all_ins_dcouments as $ins_doc)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('basestaff.provider.insurance.document.delete',$ins_doc->id)}}"
                                       title="Delete">
                                    ...
                                    <div class="modal fade" id="editinsdoc{{$ins_doc->id}}" data-backdrop="static">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('basestaff.insurance.document.update')}}"
                                                      method="post"
                                                      enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-body">
