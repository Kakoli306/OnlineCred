                ...
                <table class="table table-sm table-bordered c_table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('admin.practice.delete',$prc->id)}}"><i class="ri-delete-bin-6-line text-danger"></i></a>
                            <!-- Edit Practice modal -->
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6 mb-2">
                                                        ...
                                                        <input type="text"
                                                               class="form-control form-control-sm" name="business_name" value="{{$prc->business_name}}" required>
                                                        <input type="hidden" class="form-control form-control-sm" name="prc_edit_id" value="{{$prc->id}}" required>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <label>DBA Name<span
                                                                class="text-danger">*</span></label>
                                                        <input type="text"
                                                               class="form-control form-control-sm" name="dba_name" value="{{$prc->dba_name}}" required>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <label>Tax Id No.<span
                                                                class="text-danger">*</span></label>
                                                        <input type="text"
                                                               class="form-control form-control-sm" name="tax_id" value="{{$prc->tax_id}}"
                                                               data-mask="00-0000000" pattern=".{10}" required>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <label>NPI<span class="text-danger">*</span></label>
                                                        <input type="text"
                                                               class="form-control form-control-sm" name="npi" value="{{$prc->npi}}"
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="row">
                                                            <div class="col-md">
                                                                <label>City<span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" name="city" value="{{$prc->city}}"
                                                            ...
                                                            <div class="col-md">
                                                                <label>State<span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" name="state" value="{{$prc->state}}"
                                                                       class="form-control form-control-sm"
                                                                       required>
                                                            </div>
                                                            <div class="col-md">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <label>Phone Number<span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" name="phone_number" value="{{$prc->phone_number}}"
                                                               class="form-control form-control-sm"
