    ...
    <div class="iq-card-body">
        ...
        <div class="d-lg-flex">
            <ul class="nav flex-column setting_menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('admin.provider.online.access',$provider->id)}}">Online
                        Access</a>
                </li>
                {{--                <li class="nav-item">--}}
                ...
                <div class="modal fade" id="addAccess" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('admin.provider.online.access.save')}}" method="post">
                                @csrf
                        ...
                        @foreach($provider_online_access as $access)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.provider.online.access.delete',$access->id)}}"
                                       title="Delete">
