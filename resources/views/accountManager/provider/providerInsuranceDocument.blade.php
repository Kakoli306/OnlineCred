                ...
                <div class="modal fade" id="adInsdoc" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('account.manager.insurance.document.save')}}" method="post"
                        ...
                        @foreach($all_ins_dcouments as $ins_doc)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('account.manager.insurance.document.delete',$ins_doc->id)}}"
                                       title="Delete">
                                    ...
                                    <div class="modal fade" id="editinsdoc{{$ins_doc->id}}" data-backdrop="static">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('account.manager.insurance.document.update')}}"
                                                      method="post"
                                                      enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-body">
