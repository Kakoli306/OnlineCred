    ...
    <div class="iq-card-body">
        ...
        <div class="d-lg-flex">
            <ul class="nav flex-column setting_menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('account.manager.provider.contract',$provider->id)}}">Contracts</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                ...
                <div class="modal fade" id="createContract" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('account.manager.provider.contract.save')}}" method="post"
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            $admins_user = \App\Models\Admin::select('id', 'name')->orderBy('id', 'desc')->get();
                        ...
                        @foreach($provider_contracts as $pcontract)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('account.manager.provider.contract.delete',$pcontract->id)}}"
                                       title="Delete">
                                    ...
                                    <div class="modal fade" id="addNote{{$pcontract->id}}">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('account.manager.provider.contract.add.note')}}"
                                                      method="post">
                                                    @csrf
                                                    <div class="modal-body">
                                                        <div class="row">
                                    ...
                                    <div class="modal fade" id="editContract{{$pcontract->id}}" data-backdrop="static">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('account.manager.provider.contract.update')}}"
...
@endsection
@include('accountManager.provider.include.contractjs')
