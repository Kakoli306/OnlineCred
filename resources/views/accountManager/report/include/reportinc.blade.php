    ...
    <script>
        $(document).ready(function () {
            let getAllFacility = function () {
                $.ajax({
                    type: "POST",
                    url: "{{route('account.manager.report.get.all.facility')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                    },
            ...
            $('.all_faciity').change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('account.manager.report.provider.by.facility')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'fac_id': fac_id
                    },
            ...
            $('.all_provider').change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('account.manager.report.contract.by.provider')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'prov_id': prov_id
                    },
